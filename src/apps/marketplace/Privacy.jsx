  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16">
      ...
      <div className="space-y-6 text-slate-700">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-8">1. L'architecture décentralisée d'Ardoise</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-8">2. Données collectées par la Plateforme</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-8">3. Utilisation des cookies</h2>
        <p>
