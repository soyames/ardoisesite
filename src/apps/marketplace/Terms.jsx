  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16">
      ...
      <div className="space-y-6 text-slate-700">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-8">1. Le Service Ardoise</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-8">2. Responsabilité des Écoles</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-8">3. Place de marché des Tuteurs</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-8">4. Litiges</h2>
        <p>
