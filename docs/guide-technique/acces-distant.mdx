...
<Info>
  Ce tunnel vous rend joignable, vous et votre personnel. Pour laisser un tiers (un [partenaire certifie](/plateforme/partenaires-certifies)) consulter l'etat de votre serveur ou de vos sauvegardes a distance sans lui donner un acces complet, utilisez plutot les **acces support** depuis l'onglet Activation & Installation de votre tableau de bord - jamais de SSH, jamais d'acces complet.
</Info>
